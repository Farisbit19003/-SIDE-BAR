...
const {name,discription,category,salePrice,purchasePrice,quantity,unit,store,
...
const onChange = (e) => {
  ...
  return (
    ...
    <div className="my-2 flex flex-wrap border-b-2 border-dashed  pb-8 sm:my-8">
      ...
      <Card>
      <FileInput image={featurepic} setImage={setFeaturepic} loading={loading}
    ...
    <div className="my-2 flex flex-wrap border-b-2 border-dashed  pb-8 sm:my-8">
      ...
      <Card>
        <FileInput 
        image={gallerypics} setImage={setGallerypics} loading={loading}
        setloading={setLoading}
        keyPrefix="fourth" multiple="true" />
      </Card>
    </div>
    {/* GROUP AND CATEGORY */}
    <div className="my-2 flex flex-wrap border-b-2 border-dashed  pb-8 sm:my-8">
