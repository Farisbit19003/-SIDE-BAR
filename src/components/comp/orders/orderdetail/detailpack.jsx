    ...
    <>
      <div className="flex flex-col bg-white p-3  my-2  gap-2 sm:flex-row">
        ...
        <div className="flex w-full border-2 shadow border-[#248F59] rounded flex-col px-5 py-4 md:w-3/5">
          ...
          <div className="flex w-full  justify-between">
            <span className="text-sm font-bold text-heading">{singleOrder?.orderType==="Sales"?"Amount After 10% Platform Commission":"Total Amount"}<span className="ml-1 ltr:mr-auto rtl:ml-auto">:</span></span>
            <span className="text-sm font-bold text-heading">{GrandTotal*(singleOrder?.orderType==="Sales"?0.9:1)}/PKR</span>
          </div>
        </div>
      </div>
    </>
