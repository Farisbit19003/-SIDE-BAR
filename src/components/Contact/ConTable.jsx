            ...
            <div className="fixed inset-0 flex items-center justify-center z-50 bg-opacity-50 bg-gray-500">
              <div className="bg-white rounded-lg p-4 w-1/2 ">
                ...
                <div className="flex font-sans p-2 border-b flex-col">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="border h-12 outline-none rounded w-full focus:ring-[#248f59] "
                    />
                    <button
                      onClick={handleMessage}
                      className="bg-[#248f59] my-2 text-[#f2f2f2] hover:text-white hover:scale-95 transition-transform font-semibold font-sans uppercase py-2 px-4 rounded"
                    >
                ...
                <div className="flex mt-2 items-center justify-end">
                  <button
                    className="bg-[#248f59] text-[#f2f2f2] hover:text-white hover:scale-95 transition-transform font-semibold font-sans uppercase py-2 px-4 rounded"
                    onClick={closeModal}
                  >
                    Close
                  </button>
