...
const DetailsCard = ({
  ...
  return !singleShop ? (
    ...
    <div className="grid grid-cols-12 gap-6 font-sans">
      ...
      <div className="order-1 col-span-12 sm:col-span-6 xl:order-1 xl:col-span-4 3xl:col-span-3">
        <div className="flex flex-col items-center rounded shadow bg-white py-8 px-6">
          ...
          <div className="mt-5 flex w-full justify-start">
            ...
            <address className="text-sm not-italic  flex flex-col">
          ...
          <div className="mt-3 flex w-full justify-start">
            ...
            <a className="text-sm ">{singleShop?.Storewhatsapp}</a>
          </div>
      ...
      {/* Cover Photo */}
      <div className="relative flex shadow bg-white items-center justify-center order-2 col-span-12 h-full min-h-[400px] overflow-hidden rounded  bg-white xl:order-2 xl:col-span-8 3xl:col-span-9">
      ...
      <div className="order-4  col-span-12 xl:order-3 xl:col-span-9">
        <div className="grid shadow bg-white h-full grid-cols-1 gap-3 rounded  bg-white p-4 md:grid-cols-3">
      ...
      {/* Misc. Information */}
      <div className="order-3 col-span-12 shadow bg-white rounded  bg-white sm:col-span-6 xl:order-4 xl:col-span-3">
