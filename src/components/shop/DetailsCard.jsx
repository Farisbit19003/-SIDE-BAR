    ...
    <>
      <div className=" inset-0 flex items-center justify-center">
        <div className="flex flex-col items-center">
          <span className="mt-16 text-red-500 text-lg font-semibold">
      ...
      <div className="grid grid-cols-12 gap-6 font-sans">
        {singleShop?.status === "InActive" && page !== "Admin" && (
          <div className="col-span-12 rounded-lg bg-red-500 px-5 py-4 text-sm font-sans font-semibold">
            Shop is not Activated.It will be approved by Admin.You need to add
            atleast 5 Products
          </div>
        )}
        {/* ABOUT SHOP */}
          ...
          <div className="flex flex-col items-center rounded shadow bg-white py-8 px-6">
            ...
            <div className="mt-5 flex w-full justify-start">
              <span className="me-2 mt-0.5">
                <BiMapPin size={25} color="#248f59" className="align-middle" />
              </span>
              <address className="text-sm flex flex-col">
            ...
            <div className="mt-3 flex w-full justify-start">
              <span className="me-2">
                <BiPhone size={25} color="#248f59" className="align-middle" />
              </span>
              <a className="text-sm ">+92-{singleShop?.Storewhatsapp}</a>
            </div>
            ...
            <div className="mt-7 grid w-full grid-cols-1">
              <a
                ...
                target="_blank"
                className="inline-flex border-2 border-[#f2f2f2] hover:scale-95 transition-transform h-12 flex-shrink-0 items-center justify-center rounded font-sans text-[#248f59]  px-5 py-0 font-semibold leading-none  outline-none  duration-300 ease-in-out focus:ring-1 "
                rel="noreferrer"
              >
                Visit Shop
              </a>
        ...
        {/* Cover Photo */}
        <div className="relative flex shadow items-center justify-center order-2 col-span-12 h-full min-h-[400px] overflow-hidden rounded  bg-white xl:order-2 xl:col-span-8 3xl:col-span-9">
        ...
        <div className="order-4  col-span-12 xl:order-3 xl:col-span-9">
          <div className="grid shadow h-full grid-cols-1 gap-3 rounded  bg-white p-4 md:grid-cols-3">
        ...
        {/* Misc. Information */}
        <div className="order-3 col-span-12 shadow bg-white rounded sm:col-span-6 xl:order-4 xl:col-span-3">
          <div className="flex flex-col border-b border-gray-200 p-6 2xl:p-7">
            ...
            {/* SHOP REGISTERATION DATE */}
            <span className="text-sm font-semibold">
              {DateTime.fromISO(singleShop?.createdAt).toLocaleString(DateTime.DATE_HUGE)}
            </span>
          </div>
