        ...
        <div className="flex w-full border rounded border-[#f2f2f2] sm:whitespace-nowrap bg-white sm:w-8/12 md:w-2/3">
          <div className="p-3 font-sans w-full flex flex-col">
            ...
            <input
              ...
              type="text"
              name="name"
              className="h-12 mb-2  bg-white border  border-[#f2f2f2] rounded-lg px-3 py-2 text-lg font-sans font-normal tracking-normal text-left focus:outline-none focus:ring-2 focus:ring-[#248f59]"
            />
            {/* DETAIL */}
            ...
            <textarea
              ...
              onChange={handleChange}
              name="details"
              className="mb-2 bg-white border border-[#f2f2f2] rounded-lg px-3 py-2 text-lg font-sans font-normal tracking-normal text-left focus:outline-none focus:ring-2 focus:ring-[#248f59]"
            />
          </div>
        </div>
      </div>
