          ...
          <Card>
            <div className="p-3 font-sans w-full flex flex-col">
              ...
              <select
                ...
                value={store}
                name="store"
                className="h-12 mb-2  text-md focus:border-none bg-white border-gray-400 rounded-lg px-3 py-2  font-sans font-normal tracking-normal text-left focus:outline-none focus:ring-2 focus:ring-[#248f59]"
              >
