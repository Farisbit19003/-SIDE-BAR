    ...
    <>
      <Menu as="div" className="relative inline-block text-left ml-5">
        ...
        >
          ...
          >
            <Menu.Item>
              <li className="flex w-full flex-col space-y-1 rounded-t bg-[#248F59] px-4 py-3 text-sm text-white">
            ...
            <Menu.Item>
              <li className="cursor-pointer border-b border-gray-100 last:border-0">
                <div className="block px-4 py-3 hover:text-[#248f59] text-sm font-semibold capitalize transition duration-200 ">
            ...
            <Menu.Item>
              ...
              >
                <p className="block px-4 hover:text-[#248f59] py-3 text-sm font-semibold capitalize transition duration-200" >        
                  Logout
                </p>
              </li>
            </Menu.Item>
